...
![Setup-Banner](https://www.expresslrs.org/assets/external/github.com/ExpressLRS/ExpressLRS-Hardware/raw/master/img/quick-start.png)

### ArduPilot Serial Setup <a href="#ardupilot-serial-setup" id="ardupilot-serial-setup"></a>
...
Another bit you should enable on RC\_Options is the use of 420K baud rate. ExpressLRS receivers use 420K Baudrate to talk to flight controllers.

<figure><img src="https://www.expresslrs.org/assets/images/ArduRCOPTIONS.png" alt="RC_Options Bitmask"><figcaption></figcaption></figure>
...
### ArduPilot Flight Modes <a href="#ardupilot-flight-modes" id="ardupilot-flight-modes"></a>
...
### ArduPilot RSSI and Link Quality <a href="#ardupilot-rssi-and-link-quality" id="ardupilot-rssi-and-link-quality"></a>
