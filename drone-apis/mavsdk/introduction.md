...
### Programming Languages[​](https://mavsdk.mavlink.io/main/en/index.html#programming-languages) <a href="#programming-languages" id="programming-languages"></a>
...
### Getting Started[​](https://mavsdk.mavlink.io/main/en/index.html#getting-started) <a href="#getting-started" id="getting-started"></a>

Check out the quickstart guide for [C++](https://mavsdk.mavlink.io/main/en/cpp/quickstart.html) and [Python](https://mavsdk.mavlink.io/main/en/python/quickstart.html). And no matter which language you are using, use the [C++ Guide](https://mavsdk.mavlink.io/main/en/cpp/guide.html) to learn how to perform common tasks and use the library in general.

### Getting Help[​](https://mavsdk.mavlink.io/main/en/index.html#getting-help) <a href="#getting-help" id="getting-help"></a>
...
### Contributing[​](https://mavsdk.mavlink.io/main/en/index.html#contributing) <a href="#contributing" id="contributing"></a>

We welcome contributions! If you want to help or have suggestions/bug reports [please get in touch with the development team](https://mavsdk.mavlink.io/main/en/index.html#getting-help).

The [Contributing](https://mavsdk.mavlink.io/main/en/cpp/contributing/) (C++) section contains more information on how and what to contribute, including topics about building MAVSDK from source code, running our integration and unit tests, and all other aspects of core development.

### Maintenance[​](https://mavsdk.mavlink.io/main/en/index.html#maintenance) <a href="#maintenance" id="maintenance"></a>
...
### Support and issues[​](https://mavsdk.mavlink.io/main/en/index.html#support-and-issues) <a href="#support-and-issues" id="support-and-issues"></a>
...
### License[​](https://mavsdk.mavlink.io/main/en/index.html#license) <a href="#license" id="license"></a>

* The _MAVSDK_ is licensed under the permissive [BSD 3-clause](https://github.com/mavlink/MAVSDK/blob/main/LICENSE.md).
* This documentation is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license.

### Governance[​](https://mavsdk.mavlink.io/main/en/index.html#governance) <a href="#governance" id="governance"></a>

The MAVSDK project is hosted under the governance of the [Dronecode Foundation](https://www.dronecode.org/).

[![Dronecode Logo](https://mavsdk.mavlink.io/main/assets/logo_dronecode.BLTk1l_R.png)](https://www.dronecode.org/)[![Linux Foundation Logo](https://mavsdk.mavlink.io/main/assets/logo_linux_foundation.CDJAtADH.png)](https://www.linuxfoundation.org/projects)
